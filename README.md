...
1. Clone the repository to your computer https://github.com/kirsi-k/loppuprojekti-tilavaraus-applikaatio.git
2. Create .env-file in the root of server folder
...
4. Run npm install in client folder and server folder
5. Run npm start in client folder and server folder
```
## About the project
..
## Technologies
